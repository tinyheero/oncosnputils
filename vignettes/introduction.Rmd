...
# Use only chromosome 17 segments for Vignette purposes
knitr::kable(cnvDf)
```

```{r}
# Loading the PennCNV probe file
# Only the chromosome 17 probes are in this file 
probeFile <- system.file("extdata", "logR_BAF.snp_probes.17.txt", package = "oncosnputils")
...
```{r, message = FALSE}
probeDf.oncosnp <- AddOncosnp2PennCNVProbe(cnvDf, qcDf, probeDf)
